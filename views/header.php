    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0 text-center" href="/Dashboard">
                <img src="<?= url::myurl() . '/' . $app->logo ?>" class="navbar-brand-img h-100" alt="main_logo"><br>
        ...
        <div class="collapse navbar-collapse  w-auto h-auto" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <?php if (func::CheckAccess2($user['id'], 'admission')) { ?>
                    <li class="nav-item">
                        <a data-bs-toggle="collapse" href="#admission_dropdown" class="nav-link " aria-controls="admission_dropdown" role="button" aria-expanded="false">
                            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                ...
                <?php if (func::CheckAccess2($user['id'], 'accounts')) { ?>
                    <li class="nav-item">
                        <a data-bs-toggle="collapse" href="#general_billing" class="nav-link " aria-controls="general_billing" role="button" aria-expanded="false">
                            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                    ...
                    <li class="nav-item">
                        <a data-bs-toggle="collapse" href="#fee_transactions" class="nav-link " aria-controls="fee_transactions" role="button" aria-expanded="false">
                            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                ...
                <?php if (func::CheckAccess2($user['id'], 'transport')) { ?>
                    <li class="nav-item">
                        <a data-bs-toggle="collapse" href="#transportation_dropdown" class="nav-link " aria-controls="transportation_dropdown" role="button" aria-expanded="false">
                            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                ...
                <?php if (func::CheckAccess2($user['id'], 'academics')) { ?>
                    <li class="nav-item">
                        <a data-bs-toggle="collapse" href="#academics_dropdown" class="nav-link " aria-controls="academics_dropdown" role="button" aria-expanded="false">
                            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                        ...
                        <div class="collapse " id="academics_dropdown">
                            <ul class="nav ms-4 ps-3">
                                ...
                                <li class="nav-item ">
                                    <a class="nav-link " href="<?= func::href("/Academics/MarksEntryMain") ?>">
                                        <span class="sidenav-mini-icon"> M </span>
                                        <span class="sidenav-normal"> Marks Entry </span>
                                    </a>
                                </li>
                                <li class="nav-item ">
                                    <a class="nav-link " href="<?= func::href("/Academics/ResultSheet") ?>">
                                        <span class="sidenav-mini-icon"> M </span>
                    ...
                    <li class="nav-item">
                        <a data-bs-toggle="collapse" href="#attendance_dropdown" class="nav-link " aria-controls="attendance_dropdown" role="button" aria-expanded="false">
                            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                ...
                <?php if (func::CheckAccess2($user['id'], 'accounts')) { ?>
                    <li class="nav-item">
                        <a data-bs-toggle="collapse" href="#expense_dropdown" class="nav-link " aria-controls="expense_dropdown" role="button" aria-expanded="false">
                            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                ...
                <?php if (func::CheckAccess2($user['id'], 'users')) { ?>
                    <li class="nav-item">
                        <a data-bs-toggle="collapse" href="#user_management" class="nav-link " aria-controls="user_management" role="button" aria-expanded="false">
                            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
        ...
        <div class="sidenav-footer mx-3 mt-3 pt-3">
            <div class="card card-background shadow-none card-background-mask-primary" id="sidenavCard">
                <div class="full-background" style="background-image: url('../../assets/img/curved-images/curved9.jpg')"></div>
                <div class="card-body text-start p-3 w-100">
                    ...
                    <div class="docs-info">
                        ...
                        <a href="mailto:support@starktechlabs.in" target="_blank" class="btn btn-white btn-sm w-100 mb-0">Mail</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <nav class="navbar navbar-main navbar-expand-lg position-sticky mt-4 top-1 px-0 mx-4 shadow-none border-radius-xl z-index-sticky" id="navbarBlur" data-scroll="true">
            <div class="container-fluid py-1 px-3">
                ...
                <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                    <div class="ms-md-auto pe-md-3 d-flex align-items-center text-info font-weight-bolder badge bg-dark badge-pill m-1">
                        <?= $user['username'] ?>
                    </div>
